...
<head>
  <meta charset="utf-8">
  <title><fmt:message key="OZ_TT_AD_GC_title" /></title>
  
  <script type="text/javascript">		
		function searchGroup(){
	  		var targetForm = document.forms['olForm'];
			targetForm.action = "${pageContext.request.contextPath}/OZ_TT_AD_GC/search";
	  	...
	  	function pageSelected(pageNo){
	  		var targetForm = document.forms['olForm'];
			targetForm.action = "${pageContext.request.contextPath}/OZ_TT_AD_GC/pageSearch?pageNo="+pageNo;
			targetForm.method = "POST";
			targetForm.submit();
	  	}
	  	...
	  	function setGroup(groupId,goodsId, obj) {
			...
			$("#groupRule").val('');
  			...
  			$.ajax({
  				...
  				url : '${pageContext.request.contextPath}/OZ_TT_AD_GC/getGroupInfo?groupId='+groupId,
  				dataType : "json",
  				async:false,
  				data : "", 
	  	...
	  	function setGroupSave(){
			...
			if (goodsGroupPrice == "") {
				var message = E0002.replace("{0}", '<fmt:message key="OZ_TT_AD_GC_DIALOG_price" />')
				//showErrorSpan($("#goodsGroupPrice"), message);
				return false;
			}
			if (goodsGroupNumber == "") {
				var message = E0002.replace("{0}", '<fmt:message key="OZ_TT_AD_GC_DIALOG_number" />')
				//showErrorSpan($("#goodsGroupNumber"), message);
				return false;
			}
			if (dataFromGroup == "") {
				var message = E0002.replace("{0}", '<fmt:message key="OZ_TT_AD_GC_DIALOG_validDate" />')
			...
			$.ajax({
				type : "POST",
				contentType:'application/json',
				url : '${pageContext.request.contextPath}/OZ_TT_AD_GC/saveSetGroup',
				dataType : "json",
				async:false,
		...
		<div class="page-content">
			...
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-1 control-label textleft"><fmt:message key="OZ_TT_AD_GC_goodsId" /></label>
					<div class="col-md-3">
						<form:input type="text" path="goodsId" class="input-medium form-control"></form:input>
					</div>
					
					<label class="col-md-1 control-label textleft"><fmt:message key="OZ_TT_AD_GC_goodName" /></label>
				...
				<div class="form-group">
					...
					<label class="col-md-1 control-label"><fmt:message key="OZ_TT_AD_GC_validDate" /></label>
					<div class="col-md-4">
				...
				<div class="table-scrollable">
					...
					<tr>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_goodsId" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_goodsName" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_goodsPrice" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_goodsMax" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_goodsCurr" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_validDate" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_cost" />
						</th>
						<th scope="col">
							 <fmt:message key="OZ_TT_AD_GC_DE_isOpen" />
						</th>
						<th scope="col">
						...
						<td>
							<c:if test="${groupsItem.isOpen == '0'}">
								<button type="button" class="btn green mybtn" onclick="setGroup('${groupsItem.groupId}','${groupsItem.goodsId}',this)">
									<i class="fa fa-info"></i>&nbsp;<fmt:message key="OZ_TT_AD_GC_DE_btn" />
								</button>
							</c:if>
						</td>
					</tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="text-align: center">
					...
					<h4 class="modal-title"><fmt:message key="OZ_TT_AD_GC_DIALOG_setGroup" /></h4>
				</div>
				<div class="modal-body">
					<form action="#" class="form-horizontal">
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_goodsName" /></label>
							<div class="col-md-8">				
								<label class="control-label" id="goodGroupName"></label>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_price" /></label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_validDate" /></label>
							<div class="col-md-6">
								<div class="input-group input-large date-picker input-daterange" data-date="" data-date-format="yyyy/mm/dd">
						...
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_comment" /></label>
							<div class="col-md-8">
								<textarea id="groupComment" class="input-medium form-control" rows="3"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_desc" /></label>
							<div class="col-md-8">
								<input type="text" id="groupDesc" class="input-medium form-control"></input>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_comsumerReminder" /></label>
							<div class="col-md-8">
								<input type="text" id="groupReminder" class="input-medium form-control"></input>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4"><fmt:message key="OZ_TT_AD_GC_DIALOG_rule" /></label>
							<div class="col-md-8">
